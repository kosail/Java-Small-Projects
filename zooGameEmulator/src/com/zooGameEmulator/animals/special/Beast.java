...
public abstract class Beast extends baseAnimal {
    ...
    private String randomActionGenerator(int randomAction) {
        switch (randomAction) {
            ...
            case 2:
                return super.getName() + " emite un canto que, en lugar de ser melodioso, induce locura y desesperación en aquellos que lo escuchan. Las palabras distorsionadas y la melodía disonante crean una atmósfera cargada de horror psicológico.";
            case 3:
                return super.getName() + " se involucra en un acto de consumo grotesco, ya sea devorando a sus víctimas de una manera macabra o consumiendo algo inusual, como su propia carne. La escena está cargada de detalles repulsivos que impactan los sentidos.";
            case 4:
                return "El entorno que rodea a " + super.getName() +" experimenta una transformación grotesca, donde la realidad se distorsiona y se retuerce. Paisajes familiares se vuelven distorsionados, creando un mundo surrealista y pesadillesco.";
            case 5:
            ...
            case 6:
                return super.getName() + " fusiona lo que parecen ser dos organismos de manera aberrante. No sabes qué son, pero parecen cuerpos humanos y animales que se combinan en formas inimaginables, dando lugar a criaturas híbridas y perturbadoras. No está claro que pasa por su mente, pero parece que se divierte.";
            case 7:
            ...
            case 10:
                return super.getName() + " emite susurros ininteligibles y perturbadores que parecen provenir de dimensiones oscuras. Estos susurros no solo atormentan la mente de quienes los escuchan, sino que también contienen profecías inquietantes sobre eventos por venir.";
            default:
                return "...";
        }
    }
